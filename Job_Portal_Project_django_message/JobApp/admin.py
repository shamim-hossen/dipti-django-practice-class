...
from JobApp.models import CustomUserModel, AddJobModel, RecruiterProfileModel,RecruiterContactInfo, SeekerProfileModel,SeekerBasicInfoModel,SeekerEducationQualificationModel,SeekerWorkExperienceModel,SeekerContentModel, SeekerLastEducation
...
admin.site.register(SeekerLastEducation)