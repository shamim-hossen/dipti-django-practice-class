...
def signup(request):
    contex={
        'Acc_success_msg': 'Created account successfully.',
        'Pass_not_match': 'Password doesnt match',
    }
    ...
    if request.method=='POST':
        ...
        if password==confirm_password:
            ...
            messages.success(request, contex['Acc_success_msg'])
            return redirect('signin')
        else:
            # messages.warning(request, 'Password doesnt match')
            messages.warning(request, contex['Pass_not_match'])
